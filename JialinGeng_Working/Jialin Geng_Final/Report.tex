...
As illustrated in figure \ref{fig:multi_factor_comparison}, under the multi-factor model framework, additional systemic factors amplify the fat-tail effect, thereby increasing the Value at Risk (VaR). Furthermore, if interdependencies exist among identical systemic factors within the portfolio (as observed in Portfolio 3, shown in Figure \ref{fig:multi_factor_comparison}-(c)), the fat-tail effect can be further exacerbated, leading to an even higher VaR. Consequently, institutions need to set aside more Economic Capital (EC) to absorb potential Unexpected Losses (UL) that may be incurred over the horizon of the following year.
