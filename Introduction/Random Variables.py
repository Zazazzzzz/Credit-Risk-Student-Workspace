# ---------------------------------------------------------------
# Script Name: Simulating Weather as a Random Variable
# Author: Hongyi Shen
# Description:
...
# one trial
weather_states = ["hail", "rain", "sunny"] # possible weather outcomes, type(weather_states)
...
bins = [0.5, 1.5, 2.5, 3.5] # These numbers define the interval boundaries for the histogram.
